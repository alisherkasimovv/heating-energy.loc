        ...
        <div class="container">
            <div class="row">
                <div class="header-text">
                    ...
                    <p>@lang('index.heading-desc')</p>
                </div>
                <div class="header-feauters">
                    <ul>
                        <li>{{ $countCategory }} @lang('index.heading-cats')</li>
                        <li>{{ $countProducts }} @lang('index.heading-prods')</li>
                        <li>@lang('overall.consultation')</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="main-block">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-7 text-right">
                    <ul class="top-social-icons">
                        ...
                        <li class="whp">
                            <a href="{{ $credential->whatsapp }}" target="_blank">
                        ...
                        <li class="tg">
                            <a href="{{ $credential->telegram }}" target="_blank">
                        ...
                        <li class="fb">
                            <a href="{{ $credential->facebook }}" target="_blank">
                                <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="main-content">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="search-block">
                            <a class="list-categories" type="button" data-toggle="dropdown">@lang('overall.categories')
                    ...
                    <div class="filter-text-cap">
                        ...
                        <ul class="nav nav-pills text-center categories-filter-buttons">
                            @foreach($children as $child)
                                @if($loop->index == 0)
                                <li class="filter-buttons active"><a data-toggle="pill" href="#home">{{ $child->name }}</a></li>
                                @endif
                                @if($loop->index > 0)
                                <li class="filter-buttons"><a data-toggle="pill" href="#menu{{ $loop->index }}">{{ $child->name }}</a></li>
                                @endif
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="home" class="tab-pane fade in active">
                            <div class="row js-row mrg30">
                                @foreach($filteredProducts as $prodList)
                                    @if($loop->index == 0)
                                        ...
                                        <div class="card js-card">
                                            ...
                                            <div class="product-image">
                                                <a href="#productBlock-1" class="smooth" data-toggle="collapse" data-target="#demo">
                                                    <div class="image" style="background-image: url('{{ asset($img->url) }}')"></div>
                                                </a>
                                            </div>
                                                @break
                                            @endforeach
                                            <div class="product-description blueBg">
                                                <h3><a href="{{ route('single-product', $prod->slug) }}">{{ $prod->name }}</a></h3>
                                                <p>{{ $filter->name }}</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                @if($allProducts != null)
                <div class="popular-products mgr120">
                    <h2>@lang('overall.all-products')</h2>
