            ...
            <div class="main-content">
                            ...
                            <div class="tags">
                                <ul class="nav">
                                    <li class="selected-filter">
                                        <div class="alert">
                                            <a href="{{ route('catalogue') }}" class="close" data-dismiss="alert" aria-label="close">
                ...
                <div class="about-company mgr120">
                    <div class="col-md-7 col-xs-12 company-text">
                        <h2>@lang('index.brief')</h2>
                        {{ $credential->company_info_brief }}
                        <ul class="about-social-icnons">
                            ...
                            <li class="call-button">
                                <a href="#!" data-toggle="modal" data-target="#contactUs">
                                    <span><img src="{{ asset("img/phone_iphone.svg") }}" alt=""></span>@lang('overall.consultation')
                                </a>
                            </li>
                        </ul>
